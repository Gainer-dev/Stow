...
///
/// TODO(issue): implement — see `savings-vault::admin::initialize` for the
/// reference shape (init-guard check, instance writes, event).
pub fn initialize(
    _env: &Env,
    _admin: Address,
    _treasury: Address,
